var currentTab = 0; // Current tab is set to be the first tab (0)
        ...
        function showDoctorFields(){
            ...
            var steps = document.getElementById("stepsSpan");
            ...
            if (!doctorTab.classList.contains("tab")) {
                doctorTab.classList.add("tab");   
            }


            /*var departmentDiv = document.getElementById("department");
            departmentDiv.style.display = "block";
            var positionNameDiv = document.getElementById("positionName");
            positionNameDiv.style.display = "block";
            var phoneNumberDiv = document.getElementById("phoneNumber");
            phoneNumberDiv.style.display = "block";*/
        
            /*var frm = document.getElementById('registerUserForm') || null;
            if(frm) {
                frm.action = '/user/doctor/register'; 
            }*/
        }
        
        
        function hideDoctorFields(){
            ...
            doctorTab.classList.remove("tab");
            /*var departmentDiv = document.getElementById("department");
            departmentDiv.style.display = "none";
            var positionNameDiv = document.getElementById("positionName");
            positionNameDiv.style.display = "none";
            var phoneNumberDiv = document.getElementById("phoneNumber");
            phoneNumberDiv.style.display = "none";
            var departmentInput = document.getElementById("departmentOptions");
            ...
            /*var frm = document.getElementById('registerUserForm') || null;
            if(frm) {
                frm.action = '/user/patient/register'; 
            }*/
        }